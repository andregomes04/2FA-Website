...
def register():
    ...
    return redirect('http://127.0.0.1:5500/app_org/templates/reg_log.html')  # Redirecione para a página de login ou qualquer outra página desejada após o registro
